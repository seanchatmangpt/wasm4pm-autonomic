//! Branchless Implementation: json_find_string_escapes_simd
#[inline(always)]
#[no_mangle]
...
mod tests {
    ...
    proptest! {
        ...
        fn test_equivalence(val in any::<u64>(), aux in any::<u64>()) {
            prop_assert_eq!(json_find_string_escapes_simd_reference(val, aux), json_find_string_escapes_simd(val, aux));
        }
    }
}
