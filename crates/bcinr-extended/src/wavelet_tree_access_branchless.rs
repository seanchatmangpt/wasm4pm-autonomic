//! Branchless Implementation: wavelet_tree_access_branchless
#[inline(always)]
#[no_mangle]
...
mod tests {
    ...
    proptest! {
        ...
        fn test_equivalence(val in any::<u64>(), aux in any::<u64>()) {
            prop_assert_eq!(wavelet_tree_access_branchless_reference(val, aux), wavelet_tree_access_branchless(val, aux));
        }
    }
}
